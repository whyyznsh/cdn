(function (window, undefiend) {
  ...
  NIC.prototype = {
    ...
    // 背景图片列表
    imgList: [
      "https://cdn.jsdelivr.net/gh/whyyznsh/cdn/pcbg.jpg",
    ],
    // banner图列表
    bannerList: [
      "https://cdn.jsdelivr.net/gh/whyyznsh/cdn/pcbg.jpg",
  ...
  NIC.extend({
    ...
    setBanner: function (img, filter) {
      if (!filter) {
        ...
        $(".full_page").css({
          backgroundImage:
            'url("https://cdn.jsdelivr.net/gh/whyyznsh/cdn/bg-.png"), linear-gradient(60deg, rgba(255, 165, 150, 0.5) 5%, rgba(0, 228, 255, 0.35)), url(' +
            img +
            ")",
        });
      }
